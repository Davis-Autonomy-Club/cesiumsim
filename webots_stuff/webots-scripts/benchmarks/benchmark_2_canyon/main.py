...
GOAL = 'Reach the firefighter on the elevated plateau. You will need to ascend significantly — the target is high above ground level. You are currently in the middle of the canyon floor. You will need to ascend and then find the firefighter.'
SCENARIO_ID = 'benchmark_2_canyon'
