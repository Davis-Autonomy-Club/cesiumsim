...
BENCHMARK_SPECIFIC_FIELD = \
    '  "sequence_awareness": bool (true=drone visibly re-oriented and pursued new direction after reaching first waypoint, showing it understood mission continued)'
